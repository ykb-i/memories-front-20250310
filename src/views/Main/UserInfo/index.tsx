...
function UserUpdate({ onModalViewChange }: UserUpdateProps) {
  ...
  const onUpdateButtonClick = async () => {
    ...
    const requestBody: PatchUserRequestDto = {
      name: updateName, profileImage: newProfileImage, address: updateAddress, detailAddress: updateDetailAddress, gender: updateGender, age: updateAge ? Number(updateAge) : null
    };
